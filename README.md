...
# ML Project: Expedia Hotel Recommendations

The data used for this is: [Expedia Hotel Recommendations](https://www.kaggle.com/competitions/expedia-hotel-recommendations/data).
